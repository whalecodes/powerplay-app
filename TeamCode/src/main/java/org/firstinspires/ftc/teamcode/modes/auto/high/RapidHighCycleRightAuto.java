...
@Config("3 1+3 High Cycle Right")
@Autonomous(name = "[✔] 1+3 High Cycle Right", group = "competition")
public class RapidHighCycleRightAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && drive.isBusy()) {
            ...
            telemetry.addData("loop time", System.currentTimeMillis() - time);
    ...
    public static double DEPOSIT_Y = -11;
