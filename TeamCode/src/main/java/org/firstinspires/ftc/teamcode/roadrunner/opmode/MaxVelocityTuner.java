...
@Disabled
@Config
@Autonomous(name = "[♻] Tune Max Velocity", group = "drive")
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = DriveConstant.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * DriveConstant.WHEEL_RADIUS) / DriveConstant.GEAR_RATIO * DriveConstant.TICKS_PER_REV;
    }
}
