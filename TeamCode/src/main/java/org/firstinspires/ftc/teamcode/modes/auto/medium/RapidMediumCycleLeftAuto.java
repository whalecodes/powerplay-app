...
@Config("2 1+3 Medium Cycle Left")
@Autonomous(name = "[✔] 1+3 Medium Cycle Left", group = "competition")
public class RapidMediumCycleLeftAuto extends RoadrunnerAuto {
    ...
    public static double DEPOSIT_Y = -12;
